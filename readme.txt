...
Allows you to override the default behaviour of bbPress forums, linking them to an external site.
...
1. Upload the `bbpress-forum-redirect` directory to  `/wp-content/plugins/`
